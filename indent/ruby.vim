...
if !exists('g:ruby_indent_assignment_style')
  ...
  g:ruby_indent_assignment_style = 'hanging'
endif
...
if !exists('g:ruby_indent_hanging_elements')
  ...
  g:ruby_indent_hanging_elements = 1
endif

set nosmartindent

# Now, set up our indentation expression and keys that trigger it.
setlocal indentexpr=g:GetRubyIndent(v:lnum)
...
def g:GetRubyIndent(lnum: number): number
  # 2.1. Setup {{{2
  # ----------
