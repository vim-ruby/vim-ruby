...
" Info:		$Id: ruby.vim,v 1.70 2005/09/03 14:49:11 dkearns Exp $
...
if !exists("ruby_no_expensive")
  ...
  syn region rubyOptDoBlock start="\<for\>" start="\%(\%(^\|;\)\s*\)\@<=\<\%(until\|while\)\>" matchgroup=rubyControl2 end="\<end\>" contains=ALLBUT,@rubyExtendedStringSpecial,rubyTodo nextgroup=rubyOptDoLine fold
